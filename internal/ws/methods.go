...
// decodeStringMap converts a JSON-RPC result into a map[string]string.
...
// handleGetVersion is a device-side stub handler for getVersion.
...
// handleGetSshAuthorizedKeys is a device-side stub handler for getSshAuthorizedKeys.
